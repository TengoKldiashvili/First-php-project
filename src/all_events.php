<?php
$all_posts = mysqli_fetch_all($connect->query("SELECT posts.name, posts.imgs, posts.id, posts.event_date, posts.location, navs.name, posts.registration_deadline FROM posts LEFT JOIN navs ON posts.navs_id = navs.id WHERE posts.is_approved = 1 ORDER BY posts.created_at DESC"));
$current_time = time();
...
<section class="page-heading">
    ...
    <p>TW — Tech World</p>
    <h1>ღონისძიებები</h1>
    <span>ყველა ღონისძიება საიტზე დამატების დროის მიხედვით.</span>
</section>
